...
import { FinGuardWorkspace } from './FinGuardWorkspace';
      ...
      >
        {!hasDataset || showIngestionGate ? (
          ...
          <FinGuardWorkspace
            activeAct={activeAct}
            dataset={dataset}
            askInitialPrompt={askInitialPrompt}
            setActiveAct={setActiveAct}
            setSelectedTransaction={setSelectedTransaction}
            setIsTransparencyOpen={setIsTransparencyOpen}
            handleProceedToAskWithPrompt={handleProceedToAskWithPrompt}
            handleDisputeAnomaly={handleDisputeAnomaly}
            handleAcknowledgeAnomaly={handleAcknowledgeAnomaly}
            handleOpenStory={handleOpenStory}
            handleInvestigateTransaction={handleInvestigateTransaction}
          />
        )}
      </main>
